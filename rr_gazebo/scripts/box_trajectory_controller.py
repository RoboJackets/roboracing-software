...
def main():
    ...
    for loop in itertools.count(start=1):
        ...
        while not scan_empty_ or not map_empty_ and not path_straight_:
            # print("Car is not planning straight when map is empty. Make sure there is a high bias for straightness")
            # print("Map should be empty in state: WORLD_EMPTY, but it is not.")
            # print("Check that car_inscribed_radius captures the car and world_empty_obstacle_pose is far enough away.")
            time.sleep(.1)
