...
struct GroundSegmenterParams {
  GroundSegmenterParams() :
      ...
      sensor_height(0.6), //NEEDS TO BE ADJUSTED FOR ACTUAL ROBOT
...
class GroundSegmenter {
  ...
  const GroundSegmenterParams params_;
...
public:
  ...
  GroundSegmenter(const GroundSegmenterParams& params = GroundSegmenterParams());
