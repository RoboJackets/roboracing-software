...
//    geometry_msgs::Polygon visPoly;
//
//    geometry_msgs::Point32 box[5];


//    box.x = 2.0;

//    box geometry_msgs::Point32[4];
...
//    visionBox.header.frame_id = "base_footprint";
//
//    visionBox.polygon.points = std::vector<geometry_msgs::Point32>();
//
//    visionBox.polygon.points[0].y = MIN_FRONT_VISION;
//    visionBox.polygon.points[0].x = MIN_SIDE_VISION;
//    visionBox.polygon.points[1].y = MAX_FRONT_VISION;
//    visionBox.polygon.points[1].x = MIN_SIDE_VISION;
//    visionBox.polygon.points[2].y = MAX_FRONT_VISION;
//    visionBox.polygon.points[2].x = MAX_SIDE_VISION;
//    visionBox.polygon.points[3].y = MIN_FRONT_VISION;
//    visionBox.polygon.points[3].x = MAX_SIDE_VISION;
//    visonBox_pub.publish(visionBox);
