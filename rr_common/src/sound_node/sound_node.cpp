...
// To get sound client to play sound file for more than 10 seconds change lines 168 and 169 of
// /opt/ros/[ROSVERSION]/sound_play/soundplay_node.py position = self.sound.query_position(Gst.Format.TIME)[1] duration
