...
void JoystickCB(const sensor_msgs::Joy::ConstPtr& msg) {
    ...
    rr_platform_msgs::speed sp_cmd;
    rr_platform_msgs::steering st_cmd;
...
int main(int argc, char** argv)
{
    ...
    speed_publisher = nh.advertise<rr_platform_msgs::speed>(speed_topic, 1);
    std::string steering_topic;
    nhp.param(std::string("steering_topic"), steering_topic, std::string("/steering"));
    steering_publisher = nh.advertise<rr_platform_msgs::steering>(steering_topic, 1);
