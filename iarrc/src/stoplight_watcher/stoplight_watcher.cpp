...
#define LIGHT_DIST_PIX 30 // Pixels between the center of red and green lights
#define MAXSUMRESULTSRED2GREEN 600 // experimental value of the max of the 2d traffic light filter
#define TRIGGERPERCENTAGE .65 // The percentage an event must be from experimental, accounting for noise, to trigger
#define LIGHT_SIZE_PIX 30 // The width or height of the observable stoplight light halo
...
void ImageCB(const sensor_msgs::Image::ConstPtr& msg) {
    ...
    if (maxResult > TRIGGERPERCENTAGE * MAXSUMRESULTSRED2GREEN) {
        ...
        ROS_INFO_STREAM((TRIGGERPERCENTAGE * MAXSUMRESULTSRED2GREEN) -  maxResult);
        //cout << "Wait for it...";
    }
    //cout << "   " << maxResult << endl;
